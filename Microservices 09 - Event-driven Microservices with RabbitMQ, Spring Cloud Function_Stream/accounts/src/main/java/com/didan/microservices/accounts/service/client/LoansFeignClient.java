...
@FeignClient(name = "loans", fallback = LoansFallback.class) // Gọi đến Microservices có name là loans, hiển thị ở Eureka Server, nếu không gọi được thì fallback sẽ được gọi
