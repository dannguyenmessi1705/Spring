...
Bên cạnh đó chúng ta có thể tự đinh nghĩa phương thức trong Repository, Spring Data JPA sẽ tự động sinh ra các câu lệnh SQL tương ứng, với các cú pháp như:
