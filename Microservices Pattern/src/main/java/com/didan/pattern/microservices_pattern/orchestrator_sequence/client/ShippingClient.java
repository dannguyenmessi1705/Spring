...
import com.didan.pattern.microservices_pattern.orchestrator_sequence.dto.ShippingResponse;
...
public class ShippingClient {
  ...
  public ShippingClient(@Value("${orchestrator_sequence.shipping.service}") String shippingServiceUrl) {
