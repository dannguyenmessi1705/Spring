...
import com.didan.pattern.microservices_pattern.orchestrator_sequence.client.ShippingClient;
...
public class ShippingOrchestrator extends Orchestrator {
  ...
  public Mono<OrchestrationRequestContext> create(OrchestrationRequestContext ctx) {
    ...
    return shippingClient.schedule(ctx.getShippingRequest()) // Gọi service Shipping để lên lịch giao hàng
        ...
        .handle(this.statusHandler()); // Xử lý trạng thái trả về từ service Shipping, nếu thất bại sẽ ném lỗi để kích hoạt quá trình hủy bỏ (rollback), nếu thành công sẽ tiếp tục quy trình
  }
