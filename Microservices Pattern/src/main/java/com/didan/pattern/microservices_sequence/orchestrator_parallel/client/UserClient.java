...
import com.didan.pattern.microservices_sequence.orchestrator_parallel.dto.PaymentRequest;
import com.didan.pattern.microservices_sequence.orchestrator_parallel.dto.PaymentResponse;
...
public class UserClient {
  ...
  public UserClient(@Value("${orchestrator_parallel.user.service}") String userServiceUrl) {
