...
import com.didan.pattern.microservices_sequence.orchestrator_parallel.dto.InventoryRequest;
import com.didan.pattern.microservices_sequence.orchestrator_parallel.dto.InventoryResponse;
...
public class InventoryClient {
  ...
  public InventoryClient(@Value("${orchestrator_parallel.inventory.service}") String inventoryServiceUrl) {
