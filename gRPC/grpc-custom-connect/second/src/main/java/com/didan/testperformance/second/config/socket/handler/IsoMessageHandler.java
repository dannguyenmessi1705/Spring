package com.didan.testperformance.second.config.socket.handler;
...
import com.didan.testperformance.second.service.IsoMessageProcessor;
...
public class IsoMessageHandler extends SimpleChannelInboundHandler<ISOMsg> {
  ...
  public IsoMessageHandler(GenericPackager packager, LogsInfoRepository logsInfoRepository) {
    this.decoder = new IsoMessageDecoder(packager);
    this.messageProcessor = new IsoMessageProcessor(logsInfoRepository);
  }
