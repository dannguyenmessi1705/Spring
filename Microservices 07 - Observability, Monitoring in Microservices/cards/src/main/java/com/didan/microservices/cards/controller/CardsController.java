package com.didan.microservices.cards.controller;

import com.didan.microservices.cards.constants.CardsConstants;
import com.didan.microservices.cards.dto.CardsContactInfoDto;
import com.didan.microservices.cards.dto.CardsDto;
import com.didan.microservices.cards.dto.ErrorResponseDto;
import com.didan.microservices.cards.dto.ResponseDto;
...
public class CardsController {
  ...
  public ResponseEntity<CardsDto> fetchCardDetails(
      ...
      @Pattern(regexp = "(^$|[0-9]{10})", message = "Mobile number must be 10 digits")
      String mobileNumber) {
    logger.debug("fetchCardsDetails started");
    CardsDto cardsDto = iCardsService.fetchCard(mobileNumber);
    logger.debug("fetchCardsDetails ended");
